/* Every image is hot-linked from the live guestpix.com CDN. Nothing is stored locally. */

const U = "https://guestpix.com/wp-content/uploads";

export const LOGO = `${U}/2023/11/GUESTPIX-TM-LOGO_DARK-PINK_HEX-EB8783-2-e1785123476138-1024x288.webp`;
...
export const HERO_WEDDING = `${U}/GUESTPIX-QR-CODE-WEDDING-PICTURES-71-scaled-e1769553001908.jpg`;
export const HERO_HOME = `${U}/GUESTPIX-Bridesmaids-Feature-2-to-1.jpg`;
...
export const FEATURE_ICONS = {
  social: `${U}/GUESTPIX-social-engagement-galleries.png`,
...
export const TEMPLATE_PHOTOS = [
  ...
  { src: `${T}/GUESTPIX-April-2023-26-scaled-rif3nwxzlgavuzx8mgiuzru2a7lkrtz5twhgn9mcis.jpg`, alt: "I Spy game card with a QR code" },
  { src: `${T}/GUESTPIX-QR-CODE-WEDDING-PICTURES-2-scaled-e1771461047276-rjcz3tcpl3yfcgva1fke4sb0syku5jjcu8g4smsu78.jpg`, alt: "Wedding QR code signage" },
  ...
  { src: `${T}/GUESTPIX-Mini-Take-Home-Card-Script-1-scaled-rie81zjtvukclgtrbl09fxb4zgasb2he1om3a0u57o.jpg`, alt: "Mini take-home QR code card" },
  { src: `${T}/Guest-Pix-Aug-2024-4-copy-scaled-rif3pm1hxomitnghpoxlzuf0w98fo5ppqaw0u93rac.jpg`, alt: "Wedding table card template" },
  { src: `${T}/GUESTPIX-QR-CODE-WEDDING-PICTURES-320-scaled-rif3pqqovusyfp9ny8yqub8bv6l9qn8dey5g8mwsf8.jpg`, alt: "Guest scanning a wedding QR code" },
...
export const GALLERY_PHOTOS = [
  ...
  { src: `${T}/GUESTPIX-QR-CODE-WEDDING-PICTURES-255-scaled-rif3ns8sna4g8y42dwhq5b0rba8qpcgi59818vtbdw.jpg`, alt: "Wedding QR code signage" },
...
export const HOME_TILES = [
  ...
  { href: "/events/kids-parties", label: "Kids Parties", src: `${U}/guestpix-kids-parties-square-800.webp` },
] as const;
...
export const REVIEW_PHOTOS = {
  ...
  nicolette: { src: `${T}/GUESTPIX-QR-CODE-WEDDING-PICTURES-320-scaled-rif3pqqovusyfp9ny8yqub8bv6l9qn8dey5g8mwsf8.jpg`, alt: "Guest scanning a wedding QR code" },
  ...
  kate: { src: `${U}/GUESTPIX-QR-CODE-WEDDING-PICTURES-71-scaled-e1769553001908.jpg`, alt: "Wedding celebration with a QR code sign" },
} as const;

export const WHATS_NEW_IMG = `${U}/guestpix-youtube-overlay-768.webp`;
